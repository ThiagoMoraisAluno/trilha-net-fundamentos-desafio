namespace DesafioFundamentos.Models
{
    public class Estacionamento
    {
        ...
        public void AdicionarVeiculo()
        {
            ...
            string placaVeiculo = Console.ReadLine()?.Trim().ToUpper();// Remove espaços e padroniza em maiúsculas
            ...
            }else
            {
                ...
                Console.WriteLine($"Veículo com placa - {placaVeiculo} estacionado com sucesso!");
            }
        }
